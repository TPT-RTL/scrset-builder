...
var _user$project$Types$Model = F2(
	function (a, b) {
		return {env: a, image: b};
	});
var _user$project$Types$Environment = F2(
	function (a, b) {
		return {width: a, density: b};
	});
var _user$project$Types$Image = F2(
	function (a, b) {
		return {widths: a, sizes: b};
	});
var _user$project$Types$Width = F3(
	function (a, b, c) {
		return {id: a, measure: b, unit: c};
	});
var _user$project$Types$Size = F5(
	function (a, b, c, d, e) {
		return {id: a, condition: b, measure: c, unit: d, width: e};
	});
var _user$project$Types$UpdateSizeList = function (a) {
	return {ctor: 'UpdateSizeList', _0: a};
};
var _user$project$Types$UpdateWidthList = function (a) {
	return {ctor: 'UpdateWidthList', _0: a};
};
var _user$project$Types$SetEnv = function (a) {
	return {ctor: 'SetEnv', _0: a};
};
var _user$project$Types$Percent = {ctor: 'Percent'};
var _user$project$Types$ViewWidth = {ctor: 'ViewWidth'};
var _user$project$Types$Pixel = {ctor: 'Pixel'};
var _user$project$Types$MaxWidth = {ctor: 'MaxWidth'};
var _user$project$Types$MinWidth = {ctor: 'MinWidth'};
var _user$project$Types$UpdateWidthMeasure = F2(
	function (a, b) {
		return {ctor: 'UpdateWidthMeasure', _0: a, _1: b};
	});
...
var _user$project$Types$UpdateSizeWidth = F2(
	function (a, b) {
		return {ctor: 'UpdateSizeWidth', _0: a, _1: b};
	});
var _user$project$Types$UpdateSizeUnit = F2(
	function (a, b) {
		return {ctor: 'UpdateSizeUnit', _0: a, _1: b};
	});
var _user$project$Types$UpdateSizeMeasure = F2(
	function (a, b) {
		return {ctor: 'UpdateSizeMeasure', _0: a, _1: b};
	});
var _user$project$Types$UpdateSizeCondition = F2(
	function (a, b) {
		return {ctor: 'UpdateSizeCondition', _0: a, _1: b};
	});
...
var _user$project$Utils$updateIfFilter = F3(
	function (updater, filter, list) {
		...
		if (_p0.ctor === '[]') {
			...
			var _p2 = _p0._1;
			var _p1 = _p0._0;
			return filter(_p1) ? A2(
				_elm_lang$core$List_ops['::'],
				updater(_p1),
				A3(_user$project$Utils$updateIfFilter, updater, filter, _p2)) : A2(
				_elm_lang$core$List_ops['::'],
				_p1,
...
var _user$project$Utils$onChange = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$targetValue));
};
var _user$project$Utils$toCondition = function (value) {
	var _p3 = value;
	if (_p3 === 'min-width') {
		return _user$project$Types$MinWidth;
	} else {
		return _user$project$Types$MaxWidth;
	}
};
var _user$project$Utils$conditionToString = function (condition) {
	var _p4 = condition;
	if (_p4.ctor === 'MinWidth') {
		return 'min-width';
	} else {
		return 'max-width';
	}
};
var _user$project$Utils$toUnit = function (value) {
	var _p5 = value;
	switch (_p5) {
		case 'px':
			return _user$project$Types$Pixel;
		case 'vw':
			return _user$project$Types$ViewWidth;
		default:
			return _user$project$Types$Percent;
	}
};
var _user$project$Utils$unitToString = function (unit) {
	var _p6 = unit;
	switch (_p6.ctor) {
		case 'Pixel':
			return 'px';
...
var _user$project$Utils$formatMediaQuery = function (size) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'(',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Utils$conditionToString(size.condition),
			A2(
				_elm_lang$core$Basics_ops['++'],
				': ',
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Utils$unitToString(size.unit),
						')')))));
};
var _user$project$Utils$numericWithDefault = F2(
...
var _user$project$Utils$parseIntWithDefault = function (value) {
	return A2(
		_user$project$Utils$numericWithDefault,
		0,
		_elm_lang$core$String$toInt(value));
};
var _user$project$Utils$parseFloatWithDefault = function (value) {
	return A2(
		_user$project$Utils$numericWithDefault,
		0.0,
...
var _user$project$SizeList$viewUnit = function (size) {
	var unitOption = function (unit) {
		return A2(
			_elm_lang$html$Html$option,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$selected(
					_elm_lang$core$Native_Utils.eq(size.unit, unit)),
					_elm_lang$html$Html_Attributes$value(
					_user$project$Utils$unitToString(unit))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(
	...
	var updateUnit = function (value) {
		return A2(
			_user$project$Types$UpdateSizeUnit,
			size.id,
			_user$project$Utils$toUnit(value));
	};
	return A2(
		_elm_lang$html$Html$select,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Utils$onChange(updateUnit)
			]),
		A2(
			_elm_lang$core$List$map,
			unitOption,
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Types$Pixel, _user$project$Types$ViewWidth, _user$project$Types$Percent])));
};
var _user$project$SizeList$viewCondition = function (size) {
	var updateCondition = function (value) {
		return A2(
			_user$project$Types$UpdateSizeCondition,
			size.id,
			_user$project$Utils$toCondition(value));
	};
	return A2(
		_elm_lang$html$Html$select,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Utils$onChange(updateCondition)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(size.condition, _user$project$Types$MinWidth)),
						_elm_lang$html$Html_Attributes$value(
						_user$project$Utils$conditionToString(_user$project$Types$MinWidth))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(size.condition, _user$project$Types$MaxWidth)),
						_elm_lang$html$Html_Attributes$value(
						_user$project$Utils$conditionToString(_user$project$Types$MaxWidth))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Types$AddSize),
								_elm_lang$html$Html_Attributes$class('button')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Add Size')
							]))
					]))
			]));
	var header = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Condition')
					])),
				A2(
				_elm_lang$html$Html$th,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$SizeList$updateUnit = F2(
	function (size, unit) {
		return _elm_lang$core$Native_Utils.update(
			size,
			{unit: unit});
	});
var _user$project$SizeList$updateMeasure = F2(
	function (size, measure) {
		return _elm_lang$core$Native_Utils.update(
			size,
			{measure: measure});
	});
var _user$project$SizeList$updateCondition = F2(
	function (size, condition) {
		return _elm_lang$core$Native_Utils.update(
			size,
			{condition: condition});
	});
var _user$project$SizeList$newSize = function (id) {
	return {
		id: id,
		condition: _user$project$Types$MinWidth,
		measure: 0,
		unit: _user$project$Types$Pixel,
		width: _user$project$WidthList$newWidth(0)
	};
};
var _user$project$SizeList$findBestSize = F2(
	function (width, sizes) {
		var checkMaxWidth = F2(
			function (size, width) {
				return _elm_lang$core$Native_Utils.eq(size.condition, _user$project$Types$MaxWidth) && (_elm_lang$core$Native_Utils.cmp(size.measure, width.measure) > 0);
			});
		var checkMinWidth = F2(
			function (size, width) {
				return _elm_lang$core$Native_Utils.eq(size.condition, _user$project$Types$MinWidth) && (_elm_lang$core$Native_Utils.cmp(size.measure, width.measure) < 1);
			});
		var filteredSizes = A2(
			_elm_lang$core$List$filter,
			function (size) {
				return A2(checkMinWidth, size, width) || A2(checkMaxWidth, size, width);
			},
			sizes);
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$SizeList$newSize(-1),
			_elm_lang$core$List$head(filteredSizes));
	});
var _user$project$SizeList$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'AddSize':
			...
			case 'DeleteSize':
				return A2(
					_elm_lang$core$List$filter,
					function (size) {
						return !_elm_lang$core$Native_Utils.eq(size.id, _p0._0);
					},
					model);
			case 'UpdateSizeCondition':
				var updater = A2(_elm_lang$core$Basics$flip, _user$project$SizeList$updateCondition, _p0._1);
				var filter = function (size) {
					return _elm_lang$core$Native_Utils.eq(size.id, _p0._0);
				};
				return A3(_user$project$Utils$updateIfFilter, updater, filter, model);
			case 'UpdateSizeMeasure':
				var updater = A2(_elm_lang$core$Basics$flip, _user$project$SizeList$updateMeasure, _p0._1);
				var filter = function (size) {
					return _elm_lang$core$Native_Utils.eq(size.id, _p0._0);
				};
				return A3(_user$project$Utils$updateIfFilter, updater, filter, model);
			case 'UpdateSizeUnit':
				var updater = A2(_elm_lang$core$Basics$flip, _user$project$SizeList$updateUnit, _p0._1);
				var filter = function (size) {
					return _elm_lang$core$Native_Utils.eq(size.id, _p0._0);
				};
				return A3(_user$project$Utils$updateIfFilter, updater, filter, model);
				...
				var updater = function (size) {
					return _elm_lang$core$Native_Utils.update(
						size,
						{
							width: A2(
								_elm_lang$core$Maybe$withDefault,
								_user$project$WidthList$newWidth(0),
								_elm_lang$core$List$head(
									A2(
										_user$project$WidthList$update,
										_p0._1,
										_elm_lang$core$Native_List.fromArray(
											[size.width]))))
						});
		...
		switch (_p0.ctor) {
			case 'SetEnv':
				return _elm_lang$core$Native_Utils.update(
					model,
					{env: _p0._0});
			case 'UpdateWidthList':
				var prevImage = model.image;
				var image = _elm_lang$core$Native_Utils.update(
					prevImage,
					{
						widths: A2(_user$project$WidthList$update, _p0._0, prevImage.widths)
					});
				return _elm_lang$core$Native_Utils.update(
					model,
					{image: image});
			default:
				...
				var image = _elm_lang$core$Native_Utils.update(
					prevImage,
					{
						sizes: A2(_user$project$SizeList$update, _p0._0, prevImage.sizes)
					});
				return _elm_lang$core$Native_Utils.update(
					model,
					{image: image});
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('result-table ')
							]),
						A2(
							_elm_lang$core$List$append,
							_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$viewImageSettings = function (image) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Image Candidates')
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$html$Html_App$map,
								_user$project$Types$UpdateWidthList,
								_user$project$WidthList$view(image.widths))
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Display Size Settings')
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$html$Html_App$map,
								_user$project$Types$UpdateSizeList,
								_user$project$SizeList$view(image.sizes))
							]))
					]))
			]));
};
var _user$project$Main$makeImageWidth = function (width) {
	return {id: 0, measure: width, unit: _user$project$Types$Pixel};
};
var _user$project$Main$makeEnv = F2(
	function (width, density) {
		return {
			width: {id: 0, measure: width, unit: _user$project$Types$Pixel},
			density: density
		};
	});
var _user$project$Main$viewEnvironmentSettings = function (env) {
	var updateDensity = function (value) {
		return _user$project$Types$SetEnv(
			A2(
				_user$project$Main$makeEnv,
				env.width.measure,
				_user$project$Utils$parseFloatWithDefault(value)));
	};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('env-settings')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('env-input-wrapper section')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Screen Width')
							])),
						A2(
						_elm_lang$html$Html$input,
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$defaultValue(
								_elm_lang$core$Basics$toString(env.width.measure)),
								_elm_lang$html$Html_Attributes$min('320'),
								_elm_lang$html$Html_Attributes$max('1920')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Screen Density')
							])),
						A2(
						_elm_lang$html$Html$input,
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$defaultValue(
								_elm_lang$core$Basics$toString(env.density)),
								_elm_lang$html$Html_Attributes$min('0.5'),
								_elm_lang$html$Html_Attributes$max('2'),
...
var _user$project$Main$view = function (model) {
	var imgWidth = function (value) {
		return _user$project$Main$makeImageWidth(
			_user$project$Utils$parseIntWithDefault(value));
	};
	return A2(
		_elm_lang$html$Html$div,
...
var _user$project$Main$imageWidth = function (width) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(width.measure),
					_user$project$Utils$unitToString(width.unit)))
			]));
};
var _user$project$Main$initialModel = {
	env: {
		width: {id: 0, measure: 640, unit: _user$project$Types$Pixel},
		density: 1
	},
	image: {
		widths: _elm_lang$core$Native_List.fromArray(
			[
				{id: 0, measure: 200, unit: _user$project$Types$Pixel}
			]),
		sizes: _elm_lang$core$Native_List.fromArray(
			[
				{
				id: 0,
				condition: _user$project$Types$MinWidth,
				measure: 200,
				unit: _user$project$Types$Pixel,
				width: {id: 0, measure: 200, unit: _user$project$Types$Pixel}
			}
			])
	}
};
